...
function PhotoPage() {
  ...
  return (
    <section>
      ...
      >
        {selectedPhoto && <img src={selectedPhoto} alt="selected-photo" className="expanded-photo" />}
      </Modal>
      </div>
      ...
      <div>
        <Row>
          ...
          <Col span={24} sm={12} md={8}>
            <div className="photo-container" onClick={() => openModal(foto10)}>
              <img src={foto10} alt="foto10" />
            </div>
          </Col>
          <Col span={24} sm={12} md={8}>
            <div className="photo-container" onClick={() => openModal(foto11)}>
              <img src={foto11} alt="foto11" />
            </div>
          </Col>
          <Col span={24} sm={12} md={8}>
            <div className="photo-container" onClick={() => openModal(foto12)}>
              <img src={foto12} alt="foto12" />
            </div>
          </Col>
          <Col span={24} sm={12} md={8}>
            <div className="photo-container" onClick={() => openModal(foto13)}>
              <img src={foto13} alt="foto13" />
            </div>
          </Col>
          <Col span={24} sm={12} md={8}>
            <div className="photo-container" onClick={() => openModal(foto14)}>
              <img src={foto14} alt="foto14" />
            </div>
          </Col>
          <Col span={24} sm={12} md={8}>
            <div className="photo-container" onClick={() => openModal(foto15)}>
